 ...
 * Bootstrap ClassLoader是用C++编写的，在Java中看不到它，是null。它用来加载核心类库，就是在lib下的类库，Extension ClassLoader加载lib/ext下的类库，
...
public class LoaderView {
    ...
    public void bootClassLoader (){
        ...
        try {
            loader.loadClass("com.google.app");
    ...
    public void compile() {
        ...
        javac.compile(new String[]{sourceFilePath, sourceFilePath});
    }
}
